...
def write_file(filename=None, header=None, data=None, fail=False, model='auto', launchfile='import_auto.sh', worker=1, batch_size=10, init=False, conf_file=False, groupby='', sep=';',  python_exe='python',  path='./',  context=None):
    ...
    conf_file = conf_file or '%s' % os.path.join('conf', 'connection.conf')
